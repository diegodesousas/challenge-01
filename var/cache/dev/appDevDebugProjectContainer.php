...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_rest.request_matcher.0f6609cf2e3e5af4d592ced28bdccce25fc441996aeae66ffbdafcee968585e648d60285' => 'getFosRest_RequestMatcher_0f6609cf2e3e5af4d592ced28bdccce25fc441996aeae66ffbdafcee968585e648d60285Service',
            ...
            'fos_rest.request_matcher.92794aef25066513b03d871da21f1909957a954581dfe83bcf300db76f595b38dbde0c34' => 'getFosRest_RequestMatcher_92794aef25066513b03d871da21f1909957a954581dfe83bcf300db76f595b38dbde0c34Service',
            'fos_rest.request_matcher.d8f02da60db0c38623632a83187266472a5f9f0490942e3e843a971ed2a3a88b527eff94' => 'getFosRest_RequestMatcher_D8f02da60db0c38623632a83187266472a5f9f0490942e3e843a971ed2a3a88b527eff94Service',
            'fos_rest.request_matcher.deae74ca91df488aeccfac6e5c3295ae713d86767adf7cc93933ff79b08f48ce09876623' => 'getFosRest_RequestMatcher_Deae74ca91df488aeccfac6e5c3295ae713d86767adf7cc93933ff79b08f48ce09876623Service',
    ...
    {
        return $this->services['circle.curl.options.handler'] = new \Circle\RestClientBundle\Services\CurlOptionsHandler(array(10023 => array(0 => 'Content-Type: application/json')));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'challenge_diego', 'user' => 'root', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/ChallengeBundle/Entity'))), 'ChallengeBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ChallengeBundle' => 'ChallengeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e4ee5557933284c82c49130110cc56ccb9629408552c5f8f0671da9dce8094a3');
    ...
    protected function getFosRest_ExceptionFormatNegotiatorService()
    {
        ...
        $instance->add($this->get('fos_rest.request_matcher.0f6609cf2e3e5af4d592ced28bdccce25fc441996aeae66ffbdafcee968585e648d60285'), array('priorities' => array(0 => 'json'), 'fallback_format' => 'html', 'methods' => NULL, 'stop' => false, 'prefer_extension' => '2.0'));
        $instance->add($this->get('fos_rest.request_matcher.92794aef25066513b03d871da21f1909957a954581dfe83bcf300db76f595b38dbde0c34'), array('priorities' => array(0 => 'json'), 'fallback_format' => 'html', 'methods' => NULL, 'stop' => false, 'prefer_extension' => '2.0'));
        $instance->add($this->get('fos_rest.request_matcher.deae74ca91df488aeccfac6e5c3295ae713d86767adf7cc93933ff79b08f48ce09876623'), array('priorities' => array(0 => 'json'), 'fallback_format' => 'html', 'methods' => NULL, 'stop' => false, 'prefer_extension' => '2.0'));
        $instance->add($this->get('fos_rest.request_matcher.d8f02da60db0c38623632a83187266472a5f9f0490942e3e843a971ed2a3a88b527eff94'), array('priorities' => array(0 => 'json'), 'fallback_format' => 'html', 'methods' => NULL, 'stop' => false, 'prefer_extension' => '2.0'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ChallengeBundle/Resources/views'), 'Challenge');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8f6bf30e9688ff321db47803211756eb266df08f');
    }
    ...
    /**
     * Gets the 'fos_rest.request_matcher.0f6609cf2e3e5af4d592ced28bdccce25fc441996aeae66ffbdafcee968585e648d60285' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_0f6609cf2e3e5af4d592ced28bdccce25fc441996aeae66ffbdafcee968585e648d60285Service()
    {
        return $this->services['fos_rest.request_matcher.0f6609cf2e3e5af4d592ced28bdccce25fc441996aeae66ffbdafcee968585e648d60285'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/persons', NULL, NULL);
    }
    ...
    /**
     * Gets the 'fos_rest.request_matcher.92794aef25066513b03d871da21f1909957a954581dfe83bcf300db76f595b38dbde0c34' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_92794aef25066513b03d871da21f1909957a954581dfe83bcf300db76f595b38dbde0c34Service()
    {
        return $this->services['fos_rest.request_matcher.92794aef25066513b03d871da21f1909957a954581dfe83bcf300db76f595b38dbde0c34'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/cep', NULL, NULL);
    }

    /**
     * Gets the 'fos_rest.request_matcher.d8f02da60db0c38623632a83187266472a5f9f0490942e3e843a971ed2a3a88b527eff94' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_D8f02da60db0c38623632a83187266472a5f9f0490942e3e843a971ed2a3a88b527eff94Service()
    {
        return $this->services['fos_rest.request_matcher.d8f02da60db0c38623632a83187266472a5f9f0490942e3e843a971ed2a3a88b527eff94'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/maritalstatus', NULL, NULL);
    }

    /**
     * Gets the 'fos_rest.request_matcher.deae74ca91df488aeccfac6e5c3295ae713d86767adf7cc93933ff79b08f48ce09876623' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_Deae74ca91df488aeccfac6e5c3295ae713d86767adf7cc93933ff79b08f48ce09876623Service()
    {
        return $this->services['fos_rest.request_matcher.deae74ca91df488aeccfac6e5c3295ae713d86767adf7cc93933ff79b08f48ce09876623'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/category', NULL, NULL);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ef40e5b9cf40.90473507')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ChallengeBundle' => 'ChallengeBundle\\ChallengeBundle',
            ...
            'secret' => '8f6bf30e9688ff321db47803211756eb266df08f',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '8f6bf30e9688ff321db47803211756eb266df08f',
